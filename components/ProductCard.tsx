    ...
    <>
      ...
      >
        <div className="relative pt-[85%] bg-[#f4f7f6] dark:bg-[#0f172a]/60 m-1 sm:m-2 rounded-xl sm:rounded-[2rem] overflow-hidden">
          ...
          <div className="absolute bottom-2 left-2 sm:bottom-4 sm:left-4 flex items-center space-x-2 z-10">
            {storeLogo && (
              <div className="flex items-center bg-white/90 dark:bg-[#1e293b]/90 backdrop-blur-md rounded-lg sm:rounded-2xl p-1 pr-2 sm:p-1.5 sm:pr-4 shadow-lg border border-gray-100 dark:border-gray-700">
            ...
            <button 
              ...
              className="p-1.5 sm:p-2.5 bg-white/90 dark:bg-[#1e293b]/90 backdrop-blur-md rounded-lg sm:rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700 text-gray-400 hover:text-red-500 hover:scale-110 active:scale-95 transition-all"
              title="Reportar Erro"
            >
